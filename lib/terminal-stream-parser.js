...
StreamParser.prototype.clearIgnore = function(data){
  this.ignoreBytes = [];
};

StreamParser.prototype.ignore = function(data){
  if(_.isNumber(data)){
    this.ignoreBytes.push(data);
  }else{
    this.ignoreBytes = this.ignoreBytes.concat(_.toArray(data));
  }
};
